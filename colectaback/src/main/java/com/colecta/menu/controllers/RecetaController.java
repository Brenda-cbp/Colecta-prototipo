...
import com.colecta.menu.dtos.RecetaDTO;
import com.colecta.menu.dtos.RecetaDetailDTO;
import com.colecta.menu.entities.Receta;
import com.colecta.menu.service.RecetaService;
...
public class RecetaController {
	...
	public RecetaDetailDTO encontrarReceta(@PathVariable("id") Long id) throws EntityNotFoundException{
		...
		return modelMapper.map(receta, new TypeToken<RecetaDetailDTO>() {}.getType());
	}
